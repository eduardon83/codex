...
const pt: LandingLegalContent = {
  ...
  termsPrivacy: {
    ...
    blocks: [
      ...
      { type: 'lead', text: 'Bem-vindo ao Folium. Ao criar uma conta, aceitas estes termos. Lê com atenção — se tiveres menos de 18 anos, pede ajuda a um adulto para perceber bem o que estás a aceitar.' },

      { type: 'h3', text: '1. O que é o Folium' },
      { type: 'p', text: 'O Folium é uma aplicação para gerires a tua biblioteca pessoal, descobrir livros, partilhar listas de leitura e emprestar livros a colegas da tua escola e distrito.' },

      { type: 'h3', text: '2. Quem pode usar' },
      { type: 'p', text: 'O Folium está disponível para pessoas com mais de 12 anos. Se tens entre 12 e 17 anos, precisas da autorização dos teus pais ou encarregados de educação. Vamos confirmar essa autorização por email antes de ativar a tua conta.' },
      ...
      { type: 'p', text: 'O Folium permite pedir livros emprestados a outros utilizadores da tua escola ou distrito. Os livros são dos utilizadores, não do Folium. Tu és responsável pelo livro que pedes emprestado. Combina sempre a entrega dos livros em sítios seguros, de preferência na tua escola, em bibliotecas públicas, ou com um adulto presente. Nunca combines encontros com desconhecidos em sítios privados. O Folium não se responsabiliza por livros perdidos, danificados ou conflitos entre utilizadores.' },

      { type: 'h3', text: '5. O que não podes fazer' },
      { type: 'p', text: 'Insultar, ameaçar ou intimidar outros utilizadores. Partilhar conteúdo ofensivo, pornográfico ou ilegal. Tentar aceder a contas de outras pessoas. Usar o Folium para vender livros ou para fins comerciais. Copiar ou revender dados de outros utilizadores.' },
      ...
      { type: 'p', text: 'Podemos atualizar estes termos. Se houver mudanças importantes, avisamos-te por email ou no próprio Folium. Continuar a usar o Folium após as alterações significa que aceitas os novos termos.' },
      ...
      { type: 'p', text: 'Folium é operado por Worlds4Education – Jogos e Ambientes Educativos, Lda., NIPC 516583824, sediada em Avenida da República 1629, 2.º Esquerdo – 4430-206 Vila Nova de Gaia, Portugal. Email: folium@kendirstudios.pt' },
      ...
      { type: 'p', text: 'Folium é operado por Worlds4Education – Jogos e Ambientes Educativos, Lda., NIPC 516583824, sediada em Avenida da República 1629, 2.º Esquerdo – 4430-206 Vila Nova de Gaia, Portugal. Somos os responsáveis pelo tratamento dos teus dados, nos termos do RGPD.' },
      ...
      { type: 'p', text: 'Quando usas o Folium: livros que adicionas à tua biblioteca; listas de leitura que crias; empréstimos que fazes ou pedes; classificações, notas e favoritos; preferências de tema e idioma; foto de perfil (se carregares uma).' },
      { type: 'p', text: 'Automaticamente: endereço IP (para segurança, apagado após 90 dias); tipo de dispositivo e navegador; páginas que visitas no Folium.' },
      ...
      { type: 'p', text: 'Conta ativa: enquanto usares o Folium. Conta apagada: removemos tudo em até 30 dias. Registos de empréstimo fechados: 2 anos. Logs técnicos: 90 dias.' },
      ...
      { type: 'p', text: 'O Folium usa apenas armazenamento local técnico (para manter a sessão aberta e lembrar preferências). Não usamos cookies de rastreamento ou publicidade.' },

      { type: 'h3', text: '10. Alterações' },
      { type: 'p', text: 'Se mudarmos esta política, avisamos-te no Folium e por email. Alterações substanciais que afetem menores terão novo consentimento dos encarregados.' },
...
const en: LandingLegalContent = {
  about: {
    ...
    blocks: [
      ...
      { type: 'h2', text: 'About' },
      { type: 'p', text: "Folium is the educational version of Biblioteca, a project by Kendir Studios (Worlds4Education – Jogos e Ambientes Educativos, Lda.), built from our love for books and the pleasure of building our small library, one book at a time. We're huge fans of reading, and we believe that books give us something we can't find anywhere else. But reading habits are slowly disappearing from our young people and students." },
      { type: 'p', text: 'We seek to help through Folium, allowing students to discover books, explore reading plans, find libraries, share books and readings with peers, and evolve a personal library that can be a place of refuge and growth during the formative years.' },
  ...
  termsPrivacy: {
    ...
    blocks: [
      ...
      { type: 'lead', text: "Welcome to Folium. By creating an account, you accept these terms. Read carefully — if you're under 18, ask an adult for help to understand what you're accepting." },

      { type: 'h3', text: '1. What is Folium' },
      { type: 'p', text: 'Folium is an app for managing your personal library, discovering books, sharing reading lists, and lending books to classmates in your school and district.' },

      { type: 'h3', text: '2. Who can use it' },
      { type: 'p', text: 'Folium is available for people over the age of 12. If you are between 12 and 17 years old, you need the permission of your parents or guardians. We will confirm this authorization by email before activating your account.' },
      ...
      { type: 'p', text: 'Folium lets you borrow books from other users in your school or district. The books belong to the users, not to Folium. You are responsible for the book you borrow. Always arrange to deliver books in safe places — preferably at your school, in public libraries, or with an adult present. Never arrange meetings with strangers in private places. Folium is not responsible for lost or damaged books or conflicts between users.' },

      { type: 'h3', text: "5. What you can't do" },
      { type: 'p', text: "Insulting, threatening, or intimidating other users. Sharing offensive, pornographic, or illegal content. Trying to access other people's accounts. Using Folium to sell books or for commercial purposes. Copying or reselling other users' data." },
      ...
      { type: 'p', text: 'We may update these terms. If there are major changes, we will let you know by email or in Folium itself. Continuing to use Folium after the changes means you accept the new terms.' },
      ...
      { type: 'p', text: 'Folium is operated by Worlds4Education – Jogos e Ambientes Educativos, Lda., NIPC 516583824, headquartered at Avenida da República 1629, 2nd Left – 4430-206 Vila Nova de Gaia, Portugal. Email: folium@kendirstudios.pt' },
      ...
      { type: 'p', text: 'Folium is operated by Worlds4Education – Jogos e Ambientes Educativos, Lda., NIPC 516583824, headquartered at Avenida da República 1629, 2nd Left – 4430-206 Vila Nova de Gaia, Portugal. We are the controllers of your data, under the terms of the GDPR.' },
      ...
      { type: 'p', text: 'When you use Folium: books you add to your library; reading lists you create; loans you make or request; ratings, notes, and favorites; theme and language preferences; profile picture (if you upload one).' },
      { type: 'p', text: 'Automatically: IP address (for security, erased after 90 days); device type and browser; pages you visit in Folium.' },
      ...
      { type: 'p', text: 'Active account: while you use Folium. Deleted account: we remove everything within 30 days. Closed loan records: 2 years. Technical logs: 90 days.' },
      ...
      { type: 'p', text: 'Folium uses only technical local storage (to keep the session open and remember preferences). We do not use tracking or advertising cookies.' },

      { type: 'h3', text: '10. Amendments' },
      { type: 'p', text: 'If we change this policy, we will let you know on Folium and by email. Substantial changes that affect minors will require new consent from guardians.' },
...
const es: LandingLegalContent = {
  about: {
    ...
    blocks: [
      ...
      { type: 'p', text: 'Folium es la versión educativa de Biblioteca, un proyecto de Kendir Studios (Worlds4Education – Jogos e Ambientes Educativos, Lda.), construido a partir de nuestro amor por los libros y el placer de construir nuestra pequeña biblioteca, libro a libro. Somos grandes aficionados a la lectura y creemos que los libros nos ofrecen algo que no encontramos en ningún otro sitio. Pero los hábitos de lectura están desapareciendo poco a poco de nuestros jóvenes y estudiantes.' },
      { type: 'p', text: 'Buscamos ayudar a través de Folium, permitiendo a los estudiantes descubrir libros, explorar planes de lectura, encontrar bibliotecas, compartir libros y lecturas con sus compañeros, y desarrollar una biblioteca personal que pueda ser un lugar de refugio y crecimiento durante los años formativos.' },
      { type: 'h2', text: 'Nuestra intención' },
      { type: 'p', text: 'Nuestra intención es sencilla: ofrecer a los estudiantes un lugar donde puedan catalogar sus libros, compartirlos con amigos y compañeros y descubrir nuevas lecturas. Sin algoritmos, publicidad ni ruido — ¡solo el estudiante y sus hojas!' },
      { type: 'p', text: 'Worlds4Education – Jogos e Ambientes Educativos, Lda.' },
  ...
  termsPrivacy: {
    ...
    blocks: [
      ...
      { type: 'lead', text: 'Bienvenido a Folium. Al crear una cuenta, aceptas estos términos. Lee con atención — si tienes menos de 18 años, pide ayuda a un adulto para entender qué estás aceptando.' },

      { type: 'h3', text: '1. Qué es Folium' },
      { type: 'p', text: 'Folium es una aplicación para gestionar tu biblioteca personal, descubrir libros, compartir listas de lectura y prestar libros a compañeros de tu colegio y distrito.' },

      { type: 'h3', text: '2. Quién puede usarlo' },
      { type: 'p', text: 'Folium está disponible para personas mayores de 12 años. Si tienes entre 12 y 17 años, necesitas el permiso de tus padres o tutores. Confirmaremos esta autorización por correo electrónico antes de activar tu cuenta.' },
      ...
      { type: 'p', text: 'Folium te permite pedir prestados libros de otros usuarios de tu colegio o distrito. Los libros pertenecen a los usuarios, no a Folium. Eres responsable del libro que tomas prestado. Organiza siempre la entrega en lugares seguros — preferiblemente en tu colegio, en bibliotecas públicas o con un adulto presente. Nunca organices encuentros con desconocidos en lugares privados. Folium no se hace responsable de libros perdidos, dañados o conflictos entre usuarios.' },

      { type: 'h3', text: '5. Lo que no puedes hacer' },
      { type: 'p', text: 'Insultar, amenazar o intimidar a otros usuarios. Compartir contenido ofensivo, pornográfico o ilegal. Intentar acceder a las cuentas de otras personas. Utilizar Folium para vender libros o con fines comerciales. Copiar o revender datos de otros usuarios.' },
      ...
      { type: 'p', text: 'Podemos actualizar estos términos. Si hay cambios importantes, te lo comunicaremos por correo electrónico o en Folium. Seguir usando Folium tras los cambios significa que aceptas los nuevos términos.' },
      ...
      { type: 'h3', text: '10. Contactos' },
      { type: 'p', text: 'Folium está gestionado por Worlds4Education – Jogos e Ambientes Educativos, Lda., NIPC 516583824, Avenida da República 1629, 2ª izquierda – 4430-206 Vila Nova de Gaia, Portugal. Email: folium@kendirstudios.pt' },
      ...
      { type: 'p', text: 'Folium está gestionado por Worlds4Education – Jogos e Ambientes Educativos, Lda., NIPC 516583824, Avenida da República 1629, 2ª izquierda – 4430-206 Vila Nova de Gaia, Portugal. Somos los responsables de tus datos conforme al RGPD.' },
      ...
      { type: 'p', text: 'Al usar Folium: libros que añades; listas de lectura; préstamos; valoraciones, notas y favoritos; preferencias de tema e idioma; foto de perfil (si subes una).' },
      ...
      { type: 'p', text: 'Cuenta activa: mientras uses Folium. Cuenta eliminada: borramos todo en 30 días. Préstamos cerrados: 2 años. Logs técnicos: 90 días.' },
      ...
      { type: 'p', text: 'Folium solo usa almacenamiento local técnico. No usamos cookies de rastreo ni publicidad.' },

      { type: 'h3', text: '10. Modificaciones' },
      { type: 'p', text: 'Si cambiamos esta política, te lo comunicaremos en Folium y por email. Cambios sustanciales que afecten a menores requerirán nuevo consentimiento de los tutores.' },
...
const fr: LandingLegalContent = {
  about: {
    ...
    blocks: [
      ...
      { type: 'p', text: "Notre intention est simple : offrir aux élèves un espace où ils peuvent cataloguer leurs livres, les partager avec des amis et des collègues et découvrir de nouvelles lectures. Pas d'algorithmes, de publicité ni de bruit — juste l'élève et ses feuilles !" },
      { type: 'p', text: 'Worlds4Education – Jogos e Ambientes Educativos, Lda.' },
  ...
  termsPrivacy: {
    ...
    blocks: [
      ...
      { type: 'lead', text: "Bienvenue chez Folium. En créant un compte, vous acceptez ces conditions. Lisez attentivement — si vous avez moins de 18 ans, demandez de l'aide à un adulte." },

      { type: 'h3', text: "1. Qu'est-ce que Folium" },
      { type: 'p', text: 'Folium est une application pour gérer votre bibliothèque personnelle, découvrir des livres, partager des listes de lecture et prêter des livres à vos camarades de votre école et de votre district.' },

      { type: 'h3', text: "2. Qui peut l'utiliser" },
      { type: 'p', text: "Folium est disponible pour les personnes de plus de 12 ans. Si vous avez entre 12 et 17 ans, vous avez besoin de l'autorisation de vos parents ou tuteurs. Nous confirmerons cette autorisation par e-mail avant d'activer votre compte." },
      ...
      { type: 'p', text: "Folium vous permet d'emprunter des livres à d'autres utilisateurs de votre école ou district. Les livres appartiennent aux utilisateurs, pas à Folium. Vous êtes responsable du livre que vous empruntez. Organisez toujours la livraison dans des lieux sûrs — de préférence à l'école, en bibliothèque publique, ou en présence d'un adulte. N'organisez jamais de rencontres avec des inconnus dans des lieux privés. Folium n'est pas responsable des livres perdus, endommagés ou des conflits entre utilisateurs." },

      { type: 'h3', text: '5. Ce que vous ne pouvez pas faire' },
      { type: 'p', text: "Insulter, menacer ou intimider d'autres utilisateurs. Partager du contenu offensant, pornographique ou illégal. Tenter d'accéder aux comptes d'autrui. Utiliser Folium pour vendre des livres ou à des fins commerciales. Copier ou revendre les données d'autres utilisateurs." },
      ...
      { type: 'p', text: 'Nous pouvons mettre à jour ces conditions. En cas de changements majeurs, nous vous informerons par email ou dans Folium. Continuer à utiliser Folium vaut acceptation.' },
      ...
      { type: 'h3', text: '10. Contacts' },
      { type: 'p', text: 'Folium est géré par Worlds4Education – Jogos e Ambientes Educativos, Lda., NIPC 516583824, Avenida da República 1629, 2e à gauche – 4430-206 Vila Nova de Gaia, Portugal. Email : folium@kendirstudios.pt' },
      ...
      { type: 'p', text: "Folium est géré par Worlds4Education – Jogos e Ambientes Educativos, Lda., NIPC 516583824, Avenida da República 1629, 2e à gauche – 4430-206 Vila Nova de Gaia, Portugal. Nous sommes les responsables du traitement, conformément au RGPD." },
      ...
      { type: 'p', text: 'Compte actif : tant que vous utilisez Folium. Compte supprimé : tout supprimé sous 30 jours. Prêts clos : 2 ans. Journaux techniques : 90 jours.' },
      ...
      { type: 'p', text: "Folium n'utilise qu'un stockage local technique. Pas de cookies de suivi ou de publicité." },

      { type: 'h3', text: '10. Modifications' },
      { type: 'p', text: 'Si nous modifions cette politique, nous vous en informerons via Folium et par email. Les changements substantiels touchant des mineurs nécessiteront un nouveau consentement des tuteurs.' },
